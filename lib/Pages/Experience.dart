...
//import 'package:akababi/config/add.dart';
import 'package:flutter/material.dart';

class Experiance extends StatefulWidget {
  @override
  _Experiance createState() => _Experiance();
}

class _Experiance extends State<Experiance> {
                      ...
                      Center(
                          child: Container(
                            ...
                            child: DropdownButton(
                              ...
                              value: myInitialItem,
                              items: Days.map((items) {
                                return DropdownMenuItem(value: items, child: Text(
                                    items));
                              }).toList(),
                            ),
                          )),
